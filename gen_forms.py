...
def obtener_obras(conn, mun):
    with conn.cursor(cursor_factory=psycopg2.extras.DictCursor) as cur:
        sql = """
            ...
            AND (
                mun IN ('001','008','016','022','026','030','033','045','048','051','062','075','085','086','088','101','106','107','110','112','130','135','136','137') -- Municipios en los que no se desea filtrar obras por algun motivo.
                OR (
